        ...
        <section class="bgwhite p-t-66 p-b-60">
            <div class="container">
                ...
                <div class="col-md-12 p-b-30" id="formulaire1">
                    ...
                    <a href="index.php?action=createad"><input type="submit" value="Visionner mes annonces" class="flex-c-m size10 bg4 bo-rad-23 hov1 m-text3 trans-0-4" id="boutonmenuad"</a></a>
                    <br><br>
